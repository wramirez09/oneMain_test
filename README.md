...
The production build is in the 'dist' directory to view the build run the index.html file through any web server that can serve static web files such as HTML, CSS, and JS 
